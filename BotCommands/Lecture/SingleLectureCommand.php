...
class SingleLectureCommand extends UserCommand
{
     ...
     * @var string
     */
    protected $usage = '/single_lecture';
    ...
    private function respondWithLectureView(array $data, Lecture $lecture)
    {
        ...
        foreach ($lecture->getSpeaker()->getLinks() as $link) {
            $inline_keyboard->addRow(['text' => $link->getName(), 'url' => $link->getLink()]);
        }
